...
parser.add_argument('scheme',metavar="scheme",nargs=1, help='prf scheme to use for scheduling the access trace (ReRo, ReCo, RoCo, ReTr)')
...
outfile=input_atrace[:-7]+"_"+scheme_to_use[1]+".schedule"
start_time=time.time()
sol=solveEuristically_getParallelAccesses(atrace_string[0],2,4,scheme_to_use[0])
